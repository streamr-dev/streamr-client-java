...
java -jar build/libs/client_testing-1.0-SNAPSHOT.jar -m test -s stream-encrypted-shared-signed -c config/default-ci.conf && \
java -jar build/libs/client_testing-1.0-SNAPSHOT.jar -m test -s stream-encrypted-shared-rotating-signed -c config/default-ci.conf && \
