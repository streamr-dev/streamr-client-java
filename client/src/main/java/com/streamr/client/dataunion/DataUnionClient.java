...
public final class DataUnionClient {
  ...
  private DataUnionClient(
    ...
    this.mainnetGasProvider = new EstimatedGasProvider(mainnet, 730000);
    this.sidechainGasProvider = new EstimatedGasProvider(sidechain, 3000000);
  }
  ...
  public DataUnion deployDataUnion(
      ...
      final List<String> agents)
      throws Exception {
    List<Address> agentAddresses = new ArrayList<>(agents.size());
    ...
    factoryMainnet()
        .deployNewDataUnion(
            ...
            new DynamicArray<>(Address.class, agentAddresses),
            duname)
        .send();
   ...
   */
  protected EthereumTransactionReceipt portTxToMainnet(
   ...
   */
  protected List<EthereumTransactionReceipt> portTxsToMainnet(
    ...
    List<EthereumTransactionReceipt> txs = new ArrayList<>(msgs.size());
    for (Bytes32[] msg : msgs) {
      Bytes32 id = msg[0];
      Bytes32 hash = msg[1];
      // check if message has already been sent
      if (Boolean.TRUE.equals(mainnetAMB().messageCallStatus(id).send().getValue())
          || !mainnetAMB()
        ...
        if (log.isWarnEnabled()) {
          log.warn(
              "ForeignAMB has already seen msgId {}. skipping", Numeric.toHexString(id.getValue()));
        }
        continue;
      }
  ...
  private static List<Bytes32[]> extractAmbMessagesIdAndHash(final TransactionReceipt tx) {
    ArrayList<Bytes32[]> msgs = new ArrayList<>();
  ...
  public static class Builder {
    ...
    private String sidechainFactoryAddress = "0x1b55587Beea0b5Bc96Bb2ADa56bD692870522e9f";
    private String mainnetFactoryAddress = "0x7d55f9981d4E10A193314E001b96f72FCc901e40";
    private String mainnetAdminPrivateKey;
    private String sidechainAdminPrivateKey;

    public Builder withMainnetRpcUrl(final String mainnetRpcUrl) {
      this.mainnetRpcUrl = mainnetRpcUrl;
      return this;
    }

    public Builder withMainnetFactoryAddress(final String mainnetFactoryAddress) {
      this.mainnetFactoryAddress = mainnetFactoryAddress;
      return this;
    }

    public Builder withMainnetAdminPrivateKey(final String mainnetAdminPrivateKey) {
      this.mainnetAdminPrivateKey = mainnetAdminPrivateKey;
      return this;
    }

    public Builder withSidechainRpcUrl(final String sidechainRpcUrl) {
      this.sidechainRpcUrl = sidechainRpcUrl;
      return this;
    }

    public Builder withSidechainFactoryAddress(final String sidechainFactoryAddress) {
      this.sidechainFactoryAddress = sidechainFactoryAddress;
      return this;
    }

    public Builder withSidechainAdminPrivateKey(final String sidechainAdminPrivateKey) {
      this.sidechainAdminPrivateKey = sidechainAdminPrivateKey;
      return this;
    }

    public DataUnionClient createDataUnionClient() {
      return new DataUnionClient(
          mainnetRpcUrl,
          mainnetFactoryAddress,
          mainnetAdminPrivateKey,
          sidechainRpcUrl,
          sidechainFactoryAddress,
          sidechainAdminPrivateKey);
    }
  }
}
