...
class ResendRangeRequestAdapterSpec extends Specification {
	...
	def "serialization and deserialization"(String serializedMessage, ControlMessage message) {
		...
		'[2,13,"requestId","streamId",0,[143415425455,0],[14341542564555,7],"0xbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","msgChainId","sessionToken"]' | new ResendRangeRequest("requestId", "streamId", 0, new MessageRef(143415425455L, 0L), new MessageRef(14341542564555L, 7L), TestingAddresses.PUBLISHER_ID, "msgChainId", "sessionToken")
	...
	void "fromJson (from > to)"() {
		String serializedMessage = '[2,13,"requestId","streamId",0,[143415425455,0],[143415425000,0],"0xBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB","msgChainId","sessionToken"]'
