...
class ResendLastRequestAdapterTest {
  ...
  static Stream<Arguments> testDataProvider() {
    return Stream.of(
        arguments(
            "[2,11,\"requestId\",\"streamId\",0,4,\"sessionToken\"]",
            new ResendLastRequest("requestId", "streamId", 0, 4, "sessionToken")),
        arguments(
            "[2,11,\"requestId\",\"streamId\",0,4,null]",
            new ResendLastRequest("requestId", "streamId", 0, 4, null)));
  }
}
