...
class SubscribeRequestAdapterTest {
  ...
  static Stream<Arguments> testDataProvider() {
    return Stream.of(
        arguments(
            ...
            new SubscribeRequest("requestId", "streamId", 0, "sessionToken")),
        arguments(
            "[2,9,\"requestId\",\"streamId\",0,null]",
            new SubscribeRequest("requestId", "streamId", 0, null)));
  }
}
