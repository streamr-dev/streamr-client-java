...
public class DataUnionClientTest implements StreamrConstant {
    ...
    public void setup() throws Exception {
        ...
        StreamrClientOptions opts = new StreamrClientOptions(null, SigningOptions.getDefault(), EncryptionOptions.getDefault(), StreamrConstant.DEFAULT_WEBSOCKET_URL, StreamrConstant.DEFAULT_REST_URL);
    ...
    void createDU() throws Exception {
        du = client.deployDataUnion(duname, wallets[0].getAddress(), BigInteger.ZERO, Arrays.asList(wallets[0].getAddress()));
...
//    public void withdrawMemberAsAdmin() throws Exception {
        ...
        assertEquals(client.waitForMainnetBalanceChange(recipientBal, recipient, 10000, 600000), recipientBal.add(testSendAmount));
//    }
//
//    @Test
