...
public class IERC20 extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> transfer(Address recipient, Uint256 amount) {
    ...
    public RemoteFunctionCall<TransactionReceipt> transferFrom(Address sender, Address recipient, Uint256 amount) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_TRANSFERFROM, 
