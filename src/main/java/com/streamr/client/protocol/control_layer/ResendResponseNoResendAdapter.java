...
final class ResendResponseNoResendAdapter extends ControlLayerAdapter<ResendResponseNoResend> {

  ResendResponseNoResendAdapter() {
    super(ResendResponseNoResend.class);
  }
