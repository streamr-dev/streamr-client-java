...
public class StreamMessageV32Adapter extends JsonAdapter<StreamMessage> {
  ...
  public StreamMessage fromJson(JsonReader reader) throws IOException {
    try {
      ...
      StreamMessage.Content.ContentType contentType =
          StreamMessage.Content.ContentType.fromId((byte) reader.nextInt());
      ...
      return new StreamMessage.Builder()
          ...
          .withNewGroupKey(
              serializedNewGroupKey != null
                  ? EncryptedGroupKey.deserialize(serializedNewGroupKey)
                  : null)
