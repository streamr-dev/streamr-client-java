...
class StreamrClientSpec extends StreamrSpecification {
    ...
    StreamMessage createMsg(String streamId, long timestamp, long sequenceNumber, Long prevTimestamp, Long prevSequenceNumber) {
        ...
        def map = [hello: "world"]
        return new StreamMessage.Builder().setMessageID(msgId).setPreviousMessageRef(prev).setSerializedContent(HttpUtils.mapAdapter.toJson(map)).createStreamMessage()
    }
